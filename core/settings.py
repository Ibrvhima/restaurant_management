...
MIDDLEWARE = [
    'core.middleware.AutoMigrationMiddleware',
...
# FORCER SQLite pour Render - ignorer les variables d'environnement
DATABASES = {
    'default': {
...
# Email configuration (pour les fonctionnalités avancées)
